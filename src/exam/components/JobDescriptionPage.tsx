...
export const JobDescriptionPage: React.FC<Props> = ({ examData, studentName, studentEmail, onNext }) => (
  <div className="min-h-screen bg-gray-50 flex items-center justify-center p-4">
    <div className="bg-white rounded-2xl shadow-2xl w-full max-w-2xl overflow-hidden">
      <div className="bg-slate-800 px-8 py-6 text-white">
        <p className="text-slate-400 text-xs font-medium uppercase tracking-wider mb-1">Exam Invitation</p>
      ...
      <div className="px-8 py-6">
        ...
        <div className="prose prose-sm max-w-none text-gray-600 leading-relaxed whitespace-pre-wrap bg-gray-50 rounded-xl p-4 border border-gray-100 max-h-80 overflow-y-auto">
          {examData.jobDescription?.trim()
            ...
            : <span className="text-gray-400 italic">No additional instructions provided.</span>
          }
        </div>
      </div>

      <div className="px-8 pb-8 flex items-center justify-between">
        <p className="text-xs text-gray-400">Read the instructions carefully before proceeding.</p>
        <button
          onClick={onNext}
